  ...
  return (
      <div className="divider directions">
        <div className="directionsMap">
          <MapSofia />
          <p>Nytt datum men samma tid! Kl 14.00 är ni välkomna till Sofia kyrka, som ligger på Stora Mejtens gränd i Vitabergsparken. Dit tar ni er enklast med buss 2 eller 3 från Slussen.</p>        </div>
        <div className="directionsMap">
          <MapTurbinhallen />
